...
public class JClosableTabbedPane extends JTabbedPane implements MouseListener {
    ...
    public JClosableTabbedPane() {
        ...
        new JTabbedPane();
        //设置边框
        UIManager.put("TabbedPane.contentBorderInsets", new InsetsUIResource(2, 1,
                1, 1));
        //设置边框颜色
    ...
    public void addTab(String title, Component component,boolean ret) {
        this.addTab(title, component, null,ret);
    }

    public void addTab(String title, Component component, Icon extraIcon,boolean ret) {
        if (ret){
