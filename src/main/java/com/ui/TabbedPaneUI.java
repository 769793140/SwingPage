...
public class TabbedPaneUI extends javax.swing.plaf.basic.BasicTabbedPaneUI {
    ...
    public TabbedPaneUI(String bgColorHex, String frontColorHex) {
        ...
        selectedColorSet.topGradColor1 = Color.decode("#1db0ea");//选中的最上层
        selectedColorSet.topGradColor2 = Color.decode("#1db0ea");//选中的第二层
        selectedColorSet.bottomGradColor1 = Color.decode("#1db0ea");//选中的第三层
        selectedColorSet.bottomGradColor2 = Color.decode("#1db0ea");//选中的最下层
        defaultColorSet = new ColorSet();
        defaultColorSet.topGradColor1 = Color.decode("#FFFFFF");
        //未选的最上层
        defaultColorSet.topGradColor2 = Color.decode("#ffffff");
        defaultColorSet.bottomGradColor1 = Color.decode("#ffffff");
        defaultColorSet.bottomGradColor2 = Color.decode("#ffffff");
    ...
    } //  //  public static ComponentUI createUI(JComponent c) { //      return new TabbedPaneUI(); //  }
    ...
    private Shape getDownArea(int x, int y, int w, int h) {
        ...
        Area a = new Area(rec);
        RoundRectangle2D rect = new RoundRectangle2D.Float(x, y, w, h, 15, 15); // Area b = new Area(rect); // a.intersect(b);
        return a;
    }
    ...
    protected int calculateTabWidth(int tabPlacement, int tabIndex, FontMetrics metrics) {
        return 120; //      return 10 + anchoFocoV //              + super.calculateTabWidth(tabPlacement, tabIndex, metrics);
    }
